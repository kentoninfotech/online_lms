...
@section('title', \App\Models\HomepageSetting::getSetting('pages', 'all_courses_page_title') ?? 'All Courses - LearnSmart Academy')
...
<section class="py-5 py-md-8" style="background: linear-gradient(135deg, #2563EB 0%, #4F46E5 100%); color: white;">
    <div class="container-lg text-center" data-aos="fade-up">
        ...
        <p class="lead mb-4">Join thousands of students already learning on LearnSmart Academy</p>
        @auth
