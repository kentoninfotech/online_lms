...
<div class="container-fluid">
    ...
    <div class="form-header mb-4 shadow-sm">
        <div class="container">
            <h1>
                <i class="bi bi-pencil-square me-2"></i>Edit Service: {{ $service->title }}
            </h1>
            <small class="text-white-50">Update service information and featured image</small>
        </div>
    </div>
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('admin.services.update', $service) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-4">
                            <label for="featured_image" class="form-label d-block mb-3">{{ $service->featured_image ? 'Change Image' : 'Upload Image' }} *</label>
                            <div class="image-upload-area">
                                ...
                                <input 
                                    ...
                                    {{ !$service->featured_image ? 'required' : '' }}>
