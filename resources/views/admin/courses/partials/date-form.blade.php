{{-- Partial view for displaying a course date form --}}
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="date" class="form-control @error("course_dates.{$index}.start_date") is-invalid @enderror" 
                       name="course_dates[{{ $index }}][start_date]" value="{{ $date['start_date'] ?? '' }}" required>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="date" class="form-control @error("course_dates.{$index}.end_date") is-invalid @enderror" 
                       name="course_dates[{{ $index }}][end_date]" value="{{ $date['end_date'] ?? '' }}" required>
        ...
        <div class="mt-4">
            ...
            <div id="venuesContainer-{{ $index }}" class="mb-3">
                @if(isset($date['venues']) && count($date['venues']) > 0)
