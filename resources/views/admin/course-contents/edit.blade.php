...
<div class="container-fluid">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Edit Course Content</h3>
                <p class="text-muted">Course: <strong>{{ $course->title }}</strong> | Content: <strong>{{ $content->title }}</strong></p>
            </div>
            <div class="col-auto">
    ...
    <div class="row">
        <div class="col-lg-10">
            <form action="{{ route('admin.course-contents.update', [$course, $content]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('sequence') is-invalid @enderror" 
                                        id="sequence" name="sequence" value="{{ old('sequence', $content->sequence) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                id="description" name="description" rows="3">{{ old('description', $content->description) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('content_type') is-invalid @enderror" 
                                        ...
                                        <option value="text" {{ old('content_type', $content->content_type) == 'text' ? 'selected' : '' }}>Text/HTML</option>
                                        <option value="video" {{ old('content_type', $content->content_type) == 'video' ? 'selected' : '' }}>Video</option>
                                        <option value="pdf" {{ old('content_type', $content->content_type) == 'pdf' ? 'selected' : '' }}>PDF Document</option>
                                        <option value="word" {{ old('content_type', $content->content_type) == 'word' ? 'selected' : '' }}>Word Document</option>
                                        <option value="powerpoint" {{ old('content_type', $content->content_type) == 'powerpoint' ? 'selected' : '' }}>PowerPoint</option>
                                        <option value="excel" {{ old('content_type', $content->content_type) == 'excel' ? 'selected' : '' }}>Excel Sheet</option>
                                        <option value="image" {{ old('content_type', $content->content_type) == 'image' ? 'selected' : '' }}>Image</option>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('duration_minutes') is-invalid @enderror" 
                                        id="duration_minutes" name="duration_minutes" value="{{ old('duration_minutes', $content->duration_minutes ?? 0) }}" min="0">
                        ...
                        <div class="mb-3" id="file-upload-section" style="display: none;">
                            ...
                            @if($content->file_path)
                                <div class="alert alert-info small mb-2">
                                    ...
                                    Current file: <code>{{ basename($content->file_path) }}</code>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control @error('available_from') is-invalid @enderror" 
                                        ...
                                        value="{{ old('available_from', $content->available_from ? $content->available_from->format('Y-m-d\TH:i') : '') }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control @error('available_until') is-invalid @enderror" 
                                        ...
                                        value="{{ old('available_until', $content->available_until ? $content->available_until->format('Y-m-d\TH:i') : '') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('min_reading_time_minutes') is-invalid @enderror" 
                                ...
                                value="{{ old('min_reading_time_minutes', $content->min_reading_time_minutes ?? 0) }}" min="0" max="1440">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('prerequisite_content_id') is-invalid @enderror" 
                                ...
                                @foreach($courseContents as $c)
                                    <option value="{{ $c->id }}" {{ old('prerequisite_content_id', $content->prerequisite_content_id) == $c->id ? 'selected' : '' }}>
                                        {{ $c->title }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('embed_type') is-invalid @enderror" 
                                        ...
                                        <option value="default" {{ old('embed_type', $content->embed_type ?? 'default') == 'default' ? 'selected' : '' }}>Default (Normal Page)</option>
                                        <option value="iframe" {{ old('embed_type', $content->embed_type ?? 'default') == 'iframe' ? 'selected' : '' }}>Embedded in Frame</option>
                                        <option value="popup" {{ old('embed_type', $content->embed_type ?? 'default') == 'popup' ? 'selected' : '' }}>Popup Window</option>
                                        <option value="fullscreen" {{ old('embed_type', $content->embed_type ?? 'default') == 'fullscreen' ? 'selected' : '' }}>Full Screen</option>
                                        <option value="modal" {{ old('embed_type', $content->embed_type ?? 'default') == 'modal' ? 'selected' : '' }}>Modal Dialog</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="track_viewing" 
                                            name="track_viewing" value="1" {{ old('track_viewing', $content->track_viewing ?? false) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="allow_download" 
                                            name="allow_download" value="1" {{ old('allow_download', $content->allow_download ?? false) ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="is_published" 
                                name="is_published" value="1" {{ old('is_published', $content->is_published) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="is_required" 
                                name="is_required" value="1" {{ old('is_required', $content->is_required) ? 'checked' : '' }}>
