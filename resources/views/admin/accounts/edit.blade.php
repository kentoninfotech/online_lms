...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <h2 class="fw-bold text-dark">Edit Admin Account</h2>
        ...
        <div class="col-lg-6">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Admin: {{ $admin->name }}</h5>
                </div>
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('admin.accounts.update', $admin) }}" method="POST" class="needs-validation">
                        @csrf
                        @method('PUT')
                        ...
                        <!-- Confirm Password -->
                        <div class="mb-4">
                            <label for="password_confirmation" class="form-label fw-bold">Confirm New Password <span class="text-muted">(Optional)</span></label>
                            <input type="password" 
                        ...
                        <div class="mb-4 p-3 bg-light rounded">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <strong>{{ $admin->updated_at->format('M d, Y') }}</strong>
                                </div>
                            </div>
                        </div>
...
form.addEventListener('submit', function(e) {
    ...
    // If password field is empty, that's okay (optional for edit)
    if (password.length > 0) {
