            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="subject" class="form-select @error('subject') is-invalid @enderror" required>
                        @foreach(['Algebra 1', 'Algebra 2', 'Geometry', 'Pre-Calculus', 'Mathematics', 'Science', 'Physics', 'Chemistry', 'Biology', 'Basic Science', 'Basic Technology', 'English', 'French', 'English Literature', 'Reading', 'Music', 'Yoruba', 'Igbo', 'Spanish', 'Business studies', 'Agricultural science', 'Verbal reasoning', 'Non-Verbal reasoning', 'Quantitative reasoning', 'Home Economics', 'Civic Education'] as $subject)
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="datetime-local" name="start_time" class="form-control @error('start_time') is-invalid @enderror" 
                        value="{{ old('start_time', \Carbon\Carbon::parse($lesson->start_time)->setTimezone(function_exists('getUserTimezone') ? getUserTimezone() : config('app.timezone'))->format('Y-m-d\TH:i')) }}" required>
