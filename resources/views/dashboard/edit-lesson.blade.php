            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="subject" class="form-select @error('subject') is-invalid @enderror" required>
                        @foreach(['Algebra 1', 'Algebra 2', 'Geometry', 'Pre-Calculus', 'Mathematics', 'Science', 'Physics', 'Chemistry', 'Biology', 'Basic Science', 'Basic Technology', 'English', 'French', 'English Literature', 'Reading', 'Music', 'Yoruba', 'Igbo', 'Spanish'] as $subject)
